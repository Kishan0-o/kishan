...
No Shame Clinic | Raaz MD`,
  ...
  },
  {
    ...
    video_description: `ফান্ডামেন্টাল না শিখে কাজ শেখা শুরু করলে কেন সমস্যা হয়—এই ভিডিওতে জানুন।`,
    tags: [
      "Programming Basics",
      "Education",
      "Beginner Tips",
  ...
  },
  {
    ...
    video_description: `ওয়েবসাইট হতে হয় ফাস্ট, স্মার্ট, ও ইনটুইティブ — যাতে বাড়ে ব্যবসার conversion.`,
  ...
  },
  {
    ...
    video_description: `জাস্ট একটা wrong ক্লিক, अथवा unknown লিংক… আর মুহূর্তেই আপনার বিজনেস হতে পারে সাইবার হ্যাকের এর শিকার।`,
    tags: [
      "Cyber Security",
      "Protection",
      "Ads",
